...
if ["" = "$pid"] ; then
	...
	nohup java -cp /usr/local/nagios/libexec/jt400.jar:/usr/local/nagios/libexec/nagios4i.jar com.ibm.nagios.Server -dname=nagios  > /usr/local/nagios/var/server.log &

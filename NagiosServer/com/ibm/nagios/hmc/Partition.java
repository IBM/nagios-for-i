...
public class Partition {
    ...
    private int AllocatedVirtualProcessors;
    ...
    public int getCurrentProcessors() {
        return CurrentProcessors;
    }

    public void setCurrentProcessors(int currentProcessors) {
    ...
    public int getAllocatedVirtualProcessors() {
        return AllocatedVirtualProcessors;
    }

    public void setAllocatedVirtualProcessors(int allocatedVirtualProcessors) {

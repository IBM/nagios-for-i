...
public class HMCSessionFactory {
	...
	public static ConcurrentHashMap<HMCInfo, String> sessions = new ConcurrentHashMap<HMCInfo, String>();
	
	public static String getSession(HMCInfo hmcInfo) throws Exception {
		if(sessions.get(hmcInfo) == null) {
			logonHMC(hmcInfo);
		}
		return sessions.get(hmcInfo);
	}
